...
import { SignInButton, SignInFallback } from "./sign-in-button";
...
export default async function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 border-b border-border bg-background/50 backdrop-blur-sm">
