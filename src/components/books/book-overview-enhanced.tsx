    ...
    <section className="flex flex-col-reverse items-center gap-12 sm:gap-32 xl:flex-row xl:gap-8">
      <div className="flex flex-1 flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant="secondary"
              className="border-blue-400/30 bg-blue-200/20 text-blue-200"
            >
              {language}
            </Badge>
          </div>
        ...
        <div className="space-y-3">
          ...
          {description.length > 200 && (
            <Button
              ...
              className="h-auto p-0 font-normal text-amber-400 hover:text-amber-300"
            >
              {showFullDescription ? (
                <>
        ...
        <Button
          className={`mt-6 min-h-14 w-fit transform cursor-pointer bg-gradient-to-r from-amber-500 to-amber-600 text-xl font-bold text-black shadow-lg transition-all duration-200 hover:from-amber-600 hover:to-amber-700 hover:shadow-xl max-md:w-full ${isHovered ? "scale-105" : "scale-100"} disabled:transform-none disabled:cursor-not-allowed disabled:opacity-50`}
      ...
      <div className="relative flex flex-1 justify-center">
        ...
        >
          ...
          {/* Background copies with stagger effect */}
          <div className="absolute top-8 left-12 rotate-12 opacity-30 transition-all duration-300 max-sm:hidden">
            <BookCover
              variant="wide"
              coverColor={coverColor}
              coverImage={coverUrl}
